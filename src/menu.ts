...
export const dashboardPagesMenu = {
	...
	thirdPartyIntigration: {
		id: 'thirdPartyIntigration',
		text: 'Third-Party Integrations',
		path: '/third-party-intigration',
		icon: 'Texture',
		subMenu: null,
	},
	systemSettings: {
